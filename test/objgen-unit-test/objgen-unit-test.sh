...
-I/usr/lib/llvm-10/include -D_GNU_SOURCE -D__STDC_CONSTANT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_LIMIT_MACROS -std=gnu++17 \
-L/usr/lib/llvm-10/lib -lpthread -ldl -lncurses -rdynamic -L/usr/local/lib \
-lLLVM-10 \
